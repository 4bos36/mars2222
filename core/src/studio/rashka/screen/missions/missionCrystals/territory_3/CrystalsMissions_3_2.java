...
public class CrystalsMissions_3_2 implements Crystals {
    ...
    public void render(SpriteBatch batch) {
        if (crystals != MarsGame.getPreference().getCrystal("Missions_3_2"))
            crystals = MarsGame.getPreference().getCrystal("Missions_3_2");
