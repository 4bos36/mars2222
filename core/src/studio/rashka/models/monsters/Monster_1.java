...
public class Monster_1 implements Monsters {
  ...
  //  ShapeRenderer renderer;
    ...
    public Monster_1(Vector2 position, int immunity, int type) {
    ...
    //    renderer = new ShapeRenderer();
        ...
        drawer = new Drawer(MarsGame.getTextures().loader.get("Monster_1"), MarsGame.getBatch(), null);
        immunityMonsters = new ImmunityMonsters("Monster_1", immunity);
    ...
    public void renderDie(SpriteBatch batch) {
        if (MarsGame.getFrustum().sphereInFrustum(position.x, position.y, 0, 30 * scaleSize)) {
            if (!isLiving) batch.draw(MarsGame.getTextures().textureRegion.get("Monsters_1Die"), position.x - 42 * scaleSize, position.y - 42 * scaleSize, 84 * scaleSize, 84 * scaleSize);
        }
    }
    ...
    public void render(SpriteBatch batch) {
     ...
     /*   renderer.setColor(Color.RED);
        ...
        renderer.circle(position.x * MarsGame.getRatioMonitorW(), position.y * MarsGame.getRatioMonitorH(), 18);
        renderer.end();*/
    }
