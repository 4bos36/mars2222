...
public class ShootMachineGun_4 implements Aims {
    ...
    public ShootMachineGun_4() {
        ...
        fire.get(0).load(Gdx.files.internal("particles/shoot/aim/MachineGun4.p"), Gdx.files.internal("particles"));
        fire.get(1).load(Gdx.files.internal("particles/shoot/gun/MachineGun4u.p"), Gdx.files.internal("particles"));
        fire.get(2).load(Gdx.files.internal("particles/shoot/gun/MachineGun4d.p"), Gdx.files.internal("particles"));
        fire.get(3).load(Gdx.files.internal("particles/shoot/gun/MachineGun4c.p"), Gdx.files.internal("particles"));
    ...
    public void shooting(Vector2 position, Vector2 positionFireAim, OrthographicCamera camera) {
        ...
        rotation3(MarsGame.WIDTH / 2 - 40, 540 + 66, 10, 0, position.angle());
