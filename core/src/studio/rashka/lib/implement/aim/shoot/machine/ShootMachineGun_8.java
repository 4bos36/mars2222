...
public class ShootMachineGun_8 implements Aims {
    ...
    public ShootMachineGun_8() {
        ...
        fire.get(0).load(Gdx.files.internal("particles/shoot/aim/MachineGun8.p"), Gdx.files.internal("particles"));
        fire.get(1).load(Gdx.files.internal("particles/shoot/gun/MachineGun8u.p"), Gdx.files.internal("particles"));
        fire.get(2).load(Gdx.files.internal("particles/shoot/gun/MachineGun8d.p"), Gdx.files.internal("particles"));
        fire.get(3).load(Gdx.files.internal("particles/shoot/gun/MachineGun8c.p"), Gdx.files.internal("particles"));
    ...
    public void shooting(Vector2 position, Vector2 positionFireAim, OrthographicCamera camera) {
        ...
        rotation(MarsGame.WIDTH / 2 - 195, 540 + 71, 165, -17, position.angle());
        rotation2(MarsGame.WIDTH / 2 - 195, 540 + 71, 165, 17, position.angle());
        rotation3(MarsGame.WIDTH / 2 - 195, 540 + 71, 165, 0, position.angle());
        ...
        fire.get(3).getEmitters().first().getAngle().setHigh(180 + position.angle());
    }
